...
import { BloodComponentOptions, CostSavingsExtraOptions } from '../../Presets/DataDict';
...
function WrapperCostBar({ layout }: { layout: CostLayoutElement }) {
  ...
  const plotData = useMemo(() => {
    ...
    return plotDataTemp;
  }, [BloodProductCost.PRBC_UNITS, costSavingsData, secondaryCostSavingsData, showPotential]);
  ...
  return (
    <ChartWrapperContainer>
      <ChartAccessoryDiv>
        ...
        <ExtraPairButtons disbleButton={dimensionWidth * 0.6 < extraPairTotalWidth} extraPairLength={extraPairArray.length} chartId={chartId} buttonOptions={CostSavingsExtraOptions} />
