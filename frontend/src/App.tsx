...
import { HGB_HIGH_STANDARD } from "./Presets/Constants";
        ...
        resultHemo.forEach((ob: any, index: number) => {
          ...
          if (transfused_dict[ob.CASE_ID]) {
            ...
            const outputObj: SingleCasePoint = {
              ...
              // if preop hgb is smaller than 13, that means the patient is anemia true, otherwise false.
              ANEMIA: +ob.HEMO[0] < HGB_HIGH_STANDARD ? 1 : 0,
            };
