      ...
      try {
        ...
        const surgeryCases = surgeryCasesInput.result.map((d: any) => {
          ...
          return {
            ...
            PRBC_UNITS_OUTSIDE_OR: d.PRBC_UNITS_OUTSIDE_OR ? d.PRBC_UNITS_OUTSIDE_OR : 0,
            FFP_UNITS: d.FFP_UNITS ? d.FFP_UNITS : 0,
            FFP_UNITS_OUTSIDE_OR: d.FFP_UNITS_OUTSIDE_OR ? d.FFP_UNITS_OUTSIDE_OR : 0,
            PLT_UNITS: d.PLT_UNITS ? d.PLT_UNITS : 0,
            PLT_UNITS_OUTSIDE_OR: d.PLT_UNITS_OUTSIDE_OR ? d.PLT_UNITS_OUTSIDE_OR : 0,
            CRYO_UNITS: d.CRYO_UNITS ? d.CRYO_UNITS : 0,
            CRYO_UNITS_OUTSIDE_OR: d.CRYO_UNITS_OUTSIDE_OR ? d.CRYO_UNITS_OUTSIDE_OR : 0,
            CELL_SAVER_ML: d.CELL_SAVER_ML ? d.CELL_SAVER_ML : 0,
            CELL_SAVER_ML_OUTSIDE_OR: d.CELL_SAVER_ML_OUTSIDE_OR ? d.CELL_SAVER_ML_OUTSIDE_OR : 0,
