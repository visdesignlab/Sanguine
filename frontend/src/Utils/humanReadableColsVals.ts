...
const columnNameMap: Record<string, string> = {
  ...
  cell_saver_ml: 'Cell Salvage (mL)',
  cryo_units_adherent: '# Cryoprecipitate Units Adherent',
  cryo_units: '# Cryoprecipitate Units',
  cryo_units_cost: 'Cryoprecipitate Units Cost',
  death: 'Death',
  dsch_dtm: 'Discharge Date',
  ecmo: 'ECMO',
  ffp_units_adherent: '# FFP Units Adherent',
  ffp_units: '# FFP Units',
  ...
  quarter: 'Quarter',
  rbc_units_adherent: '# RBC Units Adherent',
  rbc_units: '# RBC Units',
