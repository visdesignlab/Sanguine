...
export const AcronymDictionary = {
  ...
  PRBC_UNITS_OUTSIDE_OR: 'RBCs Transfused Outside OR',
  FFP_UNITS: 'Intraoperative FFP Transfused',
  FFP_UNITS_OUTSIDE_OR: 'FFP Transfused Outside OR',
  PLT_UNITS: 'Intraoperative Platelets Transfused',
  PLT_UNITS_OUTSIDE_OR: 'Platelets Transfused Outside OR',
  CRYO_UNITS: 'Intraoperative Cryo Transfused',
  CRYO_UNITS_OUTSIDE_OR: 'Cryo Transfused Outside OR',
  CELL_SAVER_ML: 'Cell Salvage Volume',
  CELL_SAVER_ML_OUTSIDE_OR: 'Cell Salvage Volume Outside OR',
