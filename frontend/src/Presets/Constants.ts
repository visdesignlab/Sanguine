...
export const hgbPostOpTargetRange: [number | undefined, number | undefined] = [HGB_LOW_STANDARD, HGB_LOW_STANDARD + 2];
// Post-op hgb target standard
export const HGB_HIGH_STANDARD = 13;
// Post-op hgb target standard range
export const hgbPreOpTargetRange: [number | undefined, number | undefined] = [HGB_HIGH_STANDARD, 21];
