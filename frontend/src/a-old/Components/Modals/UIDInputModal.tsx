import {
  Button, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, FormControlLabel, FormGroup, InputAdornment, Switch, TextField,
} from '@mui/material';
...
function UIDInputModal({ stateName, visible, setVisibility }: Props) {
